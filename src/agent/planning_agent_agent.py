"""Planning Agent - Main Agent Implementation."""
...
class PlanningAgentAgent:
    ...
    def __init__(self):
        ...
        self.goal_decomposition_enabled = True
        self.dependency_graphs_enabled = True
        self.strategy_selection_enabled = True
        self.progress_monitoring_enabled = True
        self.plan_adaptation_enabled = True
        self._tool_dispatch = {
            "decompose_goal": self.tools.decompose_goal,
            "build_execution_plan": self.tools.build_execution_plan,
            "evaluate_plan": self.tools.evaluate_plan,
            "adapt_plan": self.tools.adapt_plan,
            "track_progress": self.tools.track_progress,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['goal_decomposition', 'dependency_graphs', 'strategy_selection', 'progress_monitoring', 'plan_adaptation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "decompose_goal": ['decompose', 'goal'],
            "build_execution_plan": ['build', 'execution', 'plan'],
